...
ActiveRecord::Schema[7.1].define(version: 2024_04_25_044506) do
  ...
  create_table "person_memos", charset: "utf8mb3", force: :cascade do |t|
    t.bigint "person_id", null: false
    t.text "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["person_id"], name: "index_person_memos_on_person_id"
  end
  ...
  add_foreign_key "person_memos", "people"
